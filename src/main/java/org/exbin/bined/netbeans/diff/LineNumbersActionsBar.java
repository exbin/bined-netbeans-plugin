...
class LineNumbersActionsBar extends JPanel implements Scrollable, MouseMotionListener, MouseListener, PropertyChangeListener {
    ...
    private final Icon insertIcon = ImageUtilities.loadImageIcon("org/netbeans/modules/diff/builtin/visualizer/editable/insert.png", false); // NOI18N
    private final Icon removeIcon = ImageUtilities.loadImageIcon("org/netbeans/modules/diff/builtin/visualizer/editable/remove.png", false); // NOI18N

    private final Icon insertActiveIcon = ImageUtilities.loadImageIcon("org/netbeans/modules/diff/builtin/visualizer/editable/insert_active.png", false); // NOI18N
    private final Icon removeActiveIcon = ImageUtilities.loadImageIcon("org/netbeans/modules/diff/builtin/visualizer/editable/remove_active.png", false); // NOI18N
