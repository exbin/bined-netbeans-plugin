 ...
 * under the License.
 */
package org.exbin.bined.netbeans.diff.builtin;
...
public class SingleDiffPanel extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    private void initMyComponents() throws IOException {
        ...
        bNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/exbin/bined/netbeans/diff/builtin/diff-next.png"))); // NOI18N
        ...
        // setAction sets the properties from action, so init tooltip & co. afterwards
        bPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/exbin/bined/netbeans/diff/builtin/diff-prev.png"))); // NOI18N
    ...
    private void initComponents() {
        ...
        bRefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/exbin/bined/netbeans/diff/builtin/diff-refresh.png"))); // NOI18N
