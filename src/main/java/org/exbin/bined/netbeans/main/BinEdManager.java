...
import org.exbin.bined.netbeans.search.action.SearchAction;
        ...
        reloadFileMenuItem.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (editorComponent.releaseFile()) {
                    ...
                    } else if (editorComponent.getContentData() instanceof BinEdFileDataWrapper) {
                        throw new UnsupportedOperationException("Not supported yet.");
                        // TODO ((BinEdNativeFile) fileApi).reloadFile();
                    }
                }
            }
        });
